      ...
      >
        <Container className="container">
          <div className="slides" ref={slideRef}>
            <div className="slide">
              <a
                href="https://ohou.se/exhibitions/2683?affect_type=Home&affect_id=0"
                target="_blank"
              >
            ...
            <div className="slide">
              <a
                href="https://ohou.se/competitions/807?affect_type=Home&affect_id=0"
                target="_blank"
              >
            ...
            <div className="slide">
              <a
                href="https://ohou.se/exhibitions/2667?affect_type=Home&affect_id=0"
                target="_blank"
              >
                <img src="https://image.ohou.se/i/bucketplace-v2-development/uploads/banners/home_banner/166262122173492571.png" />
              </a>
            </div>

            <div className="slide">
              <a
                href="https://ohou.se/competitions/799?affect_type=Home&affect_id=0"
                target="_blank"
              >
                <img src="https://image.ohou.se/i/bucketplace-v2-development/uploads/banners/home_banner/166216891267911371.png" />
              </a>
            </div>
          </div>
